...
router.get("/home/propage", adminAuth.isLogin, dashboardController.propage);
router.get("/home/stockpage", adminAuth.isLogin, dashboardController.stockPage);
...
router.get("/rooms/edit", adminAuth.isLogin, roomController.loadEditRoom);
router.post("/rooms/edit", adminAuth.isLogin,upload.single("roomimage"), roomController.editRoom);
router.get("/rooms/delete", adminAuth.isLogin, roomController.deleteRoom);
...
router.get("/brands/edit", adminAuth.isLogin, brandController.loadEditBrand);
router.post(
  "/brands/edit",
  adminAuth.isLogin,
  upload.single("brandimage"),
...
router.get("/brands/delete", adminAuth.isLogin, brandController.deleteBrand);
...
router.get("/users/page", adminAuth.isLogin, usermanageController.pageSearch);
...
router.get(
  "/salesreport/getrangereport",
  adminAuth.isLogin,
  reportController.rangeProducts
);

router.get(
  "/salesreport/getexcelpro",
  adminAuth.isLogin,
  reportController.getExcelData
);
router.get(
  "/salesreport/getpdfpro",
  adminAuth.isLogin,
  reportController.getPdfData
);
